...
AOAI_API_VERSION = os.environ.get("AOAI_API_VERSION") # 2023-09-01-preview
COMPLETIONS_DEPLOYMENT = os.environ.get("COMPLETIONS_DEPLOYMENT_NAME")
EMBEDDINGS_DEPLOYMENT = os.environ.get("EMBEDDINGS_DEPLOYMENT_NAME")
    ...
    def __init__(self, session_id: str):
        ...
        system_message = SystemMessage(
            content = """
                ...
                You can access to the Cosmic Works database.
    ...
    def __create_agent_tools(self) -> List[Tool]:
        ...
        tools = [
            Tool(
                ...
                description = """Searches Cosmic Works product information for similar
                    products based on the question. Returns the product information
                    in JSON format.
                    """
            ),
            Tool(
